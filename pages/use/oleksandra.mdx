---
name: Oleksandra
title: Documenter and database manager for KHPG 
quote: 
image: UseCases/Oleksandra_user.png
---
...
| Skills        | Plays a dual role. Oleksandra captures evidence          |
|               | first-hand, then collects her, and others',   	       |
|               | evidence to organize and analyze an evidence archive.    |
...
|                    |                                                                                                                                                                                                                            |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](folder.svg)    | Oleksandra works as a documenter and a database manager for KHPG.                                                                                                                                                          |
