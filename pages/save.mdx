...
<GettingStartedSection>
    ...
    <GettingStartedItem>
        ...
        [![](app-store-logo.png) App Store](https://apps.apple.com/us/app/save-by-openarchive/id1462212414)

        ---

        [![Android](android-logo.png)](https://github.com/OpenArchive/Save-app-android)
    ...
    <GettingStartedItem>
        ...
        [![](play-logo.png) Google Play](https://play.google.com/store/apps/details?id=org.torproject.android&hl=en&gl=US)
        [![](app-store-logo.png) App Store](https://apps.apple.com/us/app/orbot/id1609461599)
