...
<AdditionalFeaturesSection>
    ...
    <AdditionalFeatureItem>
        ...
        Save lets you add metadata like location, people, and notes to your archived media. You can also flag certain media as “significant” as a reminder to yourself, or to prepare reviewers for what they will see.
    </AdditionalFeatureItem>
    <AdditionalFeatureItem>
        ![](additional-flag.svg)
...
<GettingStartedSection>
    ...
    <GettingStartedItem>
        ...
        [App Store](https://apps.apple.com/us/app/save-by-openarchive/id1462212414)

        ---

        [Android](https://github.com/OpenArchive/Save-app-android)
        [iOS](https://apps.apple.com/us/app/save-by-openarchive/id1462212414)

    </GettingStartedItem>
    <GettingStartedItem>
        Maximize the effects of Save's privacy-enhancing features by downloading Orbot (Tor for mobile)

        [Google Play](https://play.google.com/store/apps/details?id=org.torproject.android&hl=en&gl=US)
