...
**_Save_**’s Rights. We own all copyrights, trademarks, domains, logos, trade dress, trade secrets, patents, and other intellectual property rights associated with our Services. You may not use our copyrights, trademarks, domains, logos, trade dress, patents, and other intellectual property rights unless you have our written permission. To report copyright, trademark, or other intellectual property infringement, please contact info[at]open-archive.org.
  
**_Save_**’s License to You. Save grants you a limited, revocable, non-exclusive, and non-transferable license to use our Services in accordance with these Terms.
...
Account Information. **_Save_** does not store any information as there are no central servers associated with the project. We recommend you consult the [Internet Archive’s privacy policy](https://archive.org/about/terms.php) and terms of service. Whether using a private or public server such as the Internet Archive, you register an account with them in order to preserve your media using **_Save_**.
  
**_Save_** cannot access any content that you store in the app or transmit through the app.
User Support. If you contact **_Save_** User Support, any personal data you may share with us is kept only for the purposes of researching the issue and contacting you about your case.
  
Managing your information. You can manage your personal information in **_Save_**’s application Settings. This information will never be accessible by **_Save_** or unauthorized third parties. It is shared with the servers you choose to store media on.
